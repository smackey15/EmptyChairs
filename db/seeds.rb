...
file = open("") # url
rest1.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest2.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest3.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest4.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest5.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest6.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest7.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest8.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest9.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest10.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest11.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest12.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest13.photo_main.attach(io: file, filename: '') #photo name
...
file = open("") # url
rest14.photo_main.attach(io: file, filename: '') #photo name
